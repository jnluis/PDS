...
public class SenteNatureza {
    ...
    private static void test(PrintStream out) {
        ...
        ctgAdmin.registarServico("3003",
                new Aventura("Canyoning Ribeira da Pena", "Descida a pé da Ribeira da Pena", 80));
        ctgAdmin.registarServico("4001", new MundoRural("Pastoreio", "Pastor por um dia", 60));
        ctgAdmin.registarServico("4002",
                new MundoRural("Queijos & Doces", "Faça o seu queijo e doce para o lanche", 80));
        ...
        CatalogStats ctgStats = new CatalogStats(ctgAdmin);
    ...
    private static void alineaD(PrintStream out) {
        out.println("\nAlínea d) ----------------------------------\n");
        Historico h = new Historico("Historico");
        out.println(h.getInstance().getHistoricoString());
    }

...
public class Nostrum {
	...
	public static void main(String[] args) throws FileNotFoundException {
		PrintStream fl = new PrintStream(new File("tele.txt"));
	...
	private static void test(PrintStream out) {
		...
		gest1.registaServico("104", new Net("Fast", "Para uso domestico", 18.00, "100Mb"));
		...
		GestorServicos gest2 = new GestorServicosMinimo(gest1); // deve permitir tambem o construtor
	...
	private static void alineaD(PrintStream out) {
		// alinea d)
		out.println("\nAlinea d) ----------------------------------\n");
		Historico h = new Historico("Historio de servicos");
		out.println(h.getHistorico().getHistoricoString());
	}
